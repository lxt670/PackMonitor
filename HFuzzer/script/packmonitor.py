...
def run_framework(temperature, target_temperature, item_attack, item_asker, timestr):
    ...
    log_file_frame = f"{LOG_PATH}/PackMonitor_{item_attack.split('/')[-1]}_{item_asker.split('/')[-1]}.log"
    ...
    package_paths = [
        # "../HFuzzer/valid_packages/conda_forge.json", 
        "../valid_packages/pypi_packages.json"
    ]
    command_frame_loop = [
    ...
    command_frame_loop.extend(package_paths)
